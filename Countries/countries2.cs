 ...
 * IEnumerable Countries. After this the program does a LINQ Query where show the countries
 * with density higher to of a Continent (that we add like first parameter ). Finally this 
